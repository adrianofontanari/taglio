...
Taglio needs its significant decisions to be **discoverable, traceable,
...
|------|----------|--------|--------|
| 2026-07-23 | r1 | Adriano Fontanari | Adopted the documentation-led, ADR-driven method (seeded at bootstrap, via docflow). |
